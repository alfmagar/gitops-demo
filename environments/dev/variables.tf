...
variable "resource_group_name" {
  ...
  type        = string
  default     = "rg-demo-dev-westeu-001"
}
...
variable "vnet_name" {
  ...
  type        = string
  default     = "vnet-demo-dev-westeu-001"
}
...
variable "subnet_compute_name" {
  ...
  type        = string
  default     = "snet-compute-demo-dev-westeu-001"
}
...
variable "vm1_name" {
  ...
  type        = string
  default     = "vm-demo1-dev-westeu-001"
}
...
variable "vm2_name" {
  ...
  type        = string
  default     = "vm-demo2-dev-westeu-001"
}
...
variable "vm1_nic_name" {
  ...
  type        = string
  default     = "nic-demo1-dev-westeu-001"
}
...
variable "vm2_nic_name" {
  ...
  type        = string
  default     = "nic-demo2-dev-westeu-001"
}
